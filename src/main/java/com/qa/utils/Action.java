...
/** 
 * Action is a collection of commands which are used to
 * determine the type of function to apply to an entity.
 *
 */
public enum Action {
...
/**
 * Gets an action based on a users input. If user enters a non-specified enumeration, it will ask for another input.
 * 
 * @return Action type
 */
	public static Action getAction() {
		...
		while (true) {
			try {
				action = Action.valueOf(Input.getInput().toUpperCase());
				break;
